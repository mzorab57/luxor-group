  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4">
        ...
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between my-12">
          <div>
          ...
          <p className="text-lg md:text-xl text-gray-300 font-medium bg-gradient-to-r from-primary/10 to-transparent max-w-screen-lg rounded-xl my-4 px-2 py-4 shadow">
            ...
            life. Our custom painting service enables you to select any style
            and size, ensuring your artwork perfectly complements your space and
            personal taste.
          </p>
     
          </div>
          {location === "/" ?   <button className="mt-4 md:mt-0 border border-primary text-primary px-6 py-2 rounded-full font-medium hover:bg-primary hover:text-[#19160f] transition">
            View All Service
          </button>: ""}
